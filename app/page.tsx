...
export const metadata: Metadata = {
  ...
  description: "Bilans NGAP en 3 min, admin en 2 min, suivi patient WhatsApp, copilote clinique sourcé (56 000+ études). Conçu par des kinés libéraux. 14 jours d'essai gratuit, sans carte bancaire.",
  alternates: {
