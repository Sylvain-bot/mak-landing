...
export const metadata: Metadata = {
  ...
  description: "Mon Assistant Kiné vs ChatGPT — quel outil IA choisir pour votre cabinet kiné ? Comparatif honnête par des kinésithérapeutes praticiens.",
...
const schema = {
  ...
  "description": "Comparatif Mon Assistant Kiné vs ChatGPT pour kinésithérapeutes libéraux en France.",
...
const ROWS: { feature: string; mak: Status; chatgpt: Status; notes?: string }[] = [
  ...
  { feature: "Copilote IA Kiné (clinique & bibliographique)", mak: "yes", chatgpt: "no", notes: "Mon Assistant Kiné : Mistral (IA européenne), 56 000+ études, zéro hallucination · ChatGPT : non spécialisé, sources non fiables" },
  ...
  { feature: "Contrats de remplacement", mak: "yes", chatgpt: "no", notes: "Mon Assistant Kiné : gratuit · signature électronique · déclaration Ordre en 1 clic" },
...
const TARIFS = [
  { tool: "Mon Assistant Kiné", price: "19€/mois", note: "Offre Pionnier — 100 premiers inscrits" },
    ...
    <>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr style={{ background: "#f0f9fa", borderBottom: "1px solid #d4ecea" }}>
                  ...
                  <th className="text-center p-4 font-bold text-[#3899aa]">Mon Assistant Kiné</th>
                ...
                <tr style={{ borderTop: "1px solid #d4ecea", background: "#f8fcfd" }}>
                  ...
                  {TARIFS.map((t) => (
                    <td key={t.tool} className="p-4 text-center">
                      <div className={`font-bold ${t.tool === "Mon Assistant Kiné" ? "text-[#3899aa]" : "text-[#475569]"}`}>{t.price}</div>
      ...
      <section className="py-16 px-4 sm:px-6" style={{ background: "#f0f9fa" }}>
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              { q: "Ces outils sont-ils conformes RGPD pour des données patients ?", a: "Mon Assistant Kiné est conçu pour respecter le RGPD et les recommandations de la CNIL. Les données patients ne sont jamais utilisées pour entraîner des modèles IA tiers. Pour ChatGPT, vérifiez les conditions générales avant d'y saisir des données identifiantes de patients." },
              { q: "L'IA peut-elle remplacer le logiciel de gestion de cabinet ?", a: "Non. Mon Assistant Kiné complète ton logiciel de gestion (agenda, facturation, télétransmission) — il ne le remplace pas." },
            ].map((item) => (
      ...
      <section className="py-20 px-4 sm:px-6" style={{ background: "#3899aa" }}>
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">Essayer Mon Assistant Kiné gratuitement — sans engagement</h2>
